  ...
  function getWeatherData(city){
    ...
    getWeather.done(function(response){
      ...
      var city = response.name,
          ...
          $('.map').html('<iframe width="600" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/search?key=AIzaSyBYVFaVlAm7z6PBipNIaVb-6SZxWY8Cj-o&q=' + city + flag + '" allowfullscreen></iframe>');
    });
